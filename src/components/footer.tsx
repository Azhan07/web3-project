        ...
        <div className="container max-w-6xl mx-auto text-gray-900">
            <div className="grid grid-cols-3 justify-between">
                ...
                <div className="text-center">
                    <p className="text-gray-600 font-md">Design by. <Link className="font-lg text-gray-950 font-bold  " href='' target="_blank"> Muhammad Azhan Khan</Link> </p>
                </div>
                <div className="text-end">
                <p className="text-gray-600 font-md">Code by. <Link className="font-lg text-gray-950 font-bold  " href='https://github.com/Azhan07/web3-project' target="_blank">Muhammad Azhan Khan</Link> </p>
                </div>
            </div>
        </div>
        </div>
